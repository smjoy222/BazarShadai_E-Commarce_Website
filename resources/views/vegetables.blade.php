...
<section class="py-16 bg-gray-50">
  <div class="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="flex justify-center items-center mt-12 space-x-2">
      <button class="px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-100 transition duration-300">
        Previous
      </button>
      <button class="px-4 py-2 bg-green-600 text-white rounded-lg">1</button>
      <button class="px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-100 transition duration-300">2</button>
      <button class="px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-100 transition duration-300">3</button>
      <button class="px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-100 transition duration-300">
        Next
      </button>
    </div>
