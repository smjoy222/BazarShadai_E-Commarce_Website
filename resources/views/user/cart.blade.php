...
@section('main-content')
  ...
  <section class="py-12 bg-gray-50 min-h-screen">
    ...
    <div class="text-center py-16">
      ...
      d="M3 3h2l.4 2M7 13h10l4-8H5.4m0 0L7 13m0 0l-2.293 2.293c-.188.188-.293.442-.293.707V17h14v-1.293c0-.265-.105-.519-.293-.707L16 13" />
      </svg>
      </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
      ...
      <div class="cart-item bg-white rounded-2xl shadow-md p-6 flex items-center space-x-4"
      ...
      <button
      class="quantity-btn minus-btn w-8 h-8 bg-gray-200 rounded-full flex items-center justify-center hover:bg-gray-300 transition duration-200"
      ...
      <button
      class="quantity-btn plus-btn w-8 h-8 bg-gray-200 rounded-full flex items-center justify-center hover:bg-gray-300 transition duration-200"
    ...
    @endforeach
      ...
      class="block w-full bg-green-600 text-white py-3 rounded-lg hover:bg-green-700 font-medium transition duration-300 mb-3 text-center">
      Proceed to Checkout
      </a>

      <a href="{{ route('home') }}"
      class="block w-full text-center bg-gray-100 text-gray-700 py-3 rounded-lg hover:bg-gray-200 font-medium transition duration-300">
      Continue Shopping
      </a>
      </div>
      </div>
