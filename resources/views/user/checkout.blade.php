        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <form id="payment-form">
                ...
                <div class="mb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <input type="text" id="first_name" name="first_name" placeholder="First Name"
                            class="p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent"
                            required>
                        <input type="text" id="last_name" name="last_name" placeholder="Last Name"
                            class="p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent"
                            required>
                        <input type="email" id="email" name="email" placeholder="Email"
                            class="p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent md:col-span-2"
                            required>
                ...
                <button type="submit" id="submit-button"
                    class="w-full bg-green-600 text-white py-3 px-6 rounded-lg hover:bg-green-700 transition duration-300 font-medium disabled:opacity-50 disabled:cursor-not-allowed">
    ...
    <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
        <div class="mt-3 text-center">
            ...
            <div class="mt-2 px-7 py-3">
                ...
                <p class="text-sm font-medium text-gray-700 mt-2">Order Number: <span id="order-number"
            ...
            <div class="items-center px-4 py-3 space-y-2">
                <a href="{{ route('user.orders') }}"
                    class="block w-full px-4 py-2 bg-blue-600 text-white text-base font-medium rounded-md shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-300 text-center">
                    View My Orders
                </a>
                <button id="ok-button"
